...
import com.lxb.flink.api.java.typeutils.runtime.PojoComparator;
import com.lxb.flink.api.java.typeutils.runtime.PojoSerializer;
...
public class PojoTypeInfo<T> extends CompositeType<T> {
	...
	public <X> TypeInformation<X> getTypeAt(String fieldExpression) {
		...
		if(!matcher.matches()) {
			if (fieldExpression.startsWith(Keys.ExpressionKeys.SELECT_ALL_CHAR) || fieldExpression.startsWith(Keys.ExpressionKeys.SELECT_ALL_CHAR_SCALA)) {
