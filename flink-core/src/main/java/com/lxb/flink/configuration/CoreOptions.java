...
import com.lxb.flink.annotation.docs.ConfigGroup;
import com.lxb.flink.annotation.docs.ConfigGroups;
import com.lxb.flink.annotation.docs.Documentation;
import com.lxb.flink.configuration.description.Description;
...
public class CoreOptions {
	...
	public static final ConfigOption<String> CLASSLOADER_RESOLVE_ORDER = key("classloader.resolve-order")
	 ...
	 */
	@Documentation.Section(Documentation.Sections.EXPERT_CLASS_LOADING)
	public static final ConfigOption<String> ALWAYS_PARENT_FIRST_LOADER_PATTERNS = key("classloader.parent-first-patterns.default")
	...
	@Documentation.Section(Documentation.Sections.EXPERT_CLASS_LOADING)
	public static final ConfigOption<String> ALWAYS_PARENT_FIRST_LOADER_PATTERNS_ADDITIONAL = key("classloader.parent-first-patterns.additional")
		.defaultValue("")
		.withDescription("A (semicolon-separated) list of patterns that specifies which classes should always be" +
			" resolved through the parent ClassLoader first. A pattern is a simple prefix that is checked against" +
	...
	@Documentation.Section(Documentation.Sections.EXPERT_CLASS_LOADING)
	public static final ConfigOption<Boolean> FAIL_ON_USER_CLASS_LOADING_METASPACE_OOM = key("classloader.fail-on-metaspace-oom-error")
		.booleanType()
		.defaultValue(true)
	...
	public static final ConfigOption<String> PLUGIN_ALWAYS_PARENT_FIRST_LOADER_PATTERNS = key("plugin.classloader.parent-first-patterns.default")
		.stringType()
	...
	@Documentation.ExcludeFromDocumentation("Plugin classloader list is considered an implementation detail. " +
		"Configuration only included in case to mitigate unintended side-effects of this young feature.")
	public static final ConfigOption<String> PLUGIN_ALWAYS_PARENT_FIRST_LOADER_PATTERNS_ADDITIONAL = key("plugin.classloader.parent-first-patterns.additional")
		.stringType()
		.defaultValue("")
		.withDescription("A (semicolon-separated) list of patterns that specifies which classes should always be" +
			" resolved through the plugin parent ClassLoader first. A pattern is a simple prefix that is checked " +
	...
	public static final ConfigOption<String> FLINK_JVM_OPTIONS = key("env.java.opts")
		.stringType()
		.defaultValue("")
		.withDescription(Description.builder().text("Java options to start the JVM of all Flink processes with.").build());

	public static final ConfigOption<String> FLINK_JM_JVM_OPTIONS = key("env.java.opts.jobmanager")
		.stringType()
		.defaultValue("")
		.withDescription(Description.builder().text("Java options to start the JVM of the JobManager with.").build());

	public static final ConfigOption<String> FLINK_TM_JVM_OPTIONS = key("env.java.opts.taskmanager")
		.stringType()
		.defaultValue("")
		.withDescription(Description.builder().text("Java options to start the JVM of the TaskManager with.").build());

	public static final ConfigOption<String> FLINK_HS_JVM_OPTIONS = key("env.java.opts.historyserver")
		.stringType()
		.defaultValue("")
		.withDescription(Description.builder().text("Java options to start the JVM of the HistoryServer with.").build());

	public static final ConfigOption<String> FLINK_CLI_JVM_OPTIONS = key("env.java.opts.client")
		.stringType()
		.defaultValue("")
	...
	public static final ConfigOption<String> FLINK_LOG_DIR = key("env.log.dir")
		.noDefaultValue()
	 ...
	 */
	@SuppressWarnings("unused")
	public static final ConfigOption<Integer> FLINK_LOG_MAX = key("env.log.max")
		.defaultValue(5)
	 ...
	 */
	@SuppressWarnings("unused")
	public static final ConfigOption<String> FLINK_SSH_OPTIONS = key("env.ssh.opts")
		.noDefaultValue()
	 ...
	 */
	@SuppressWarnings("unused")
	public static final ConfigOption<String> FLINK_HADOOP_CONF_DIR = key("env.hadoop.conf.dir")
		.noDefaultValue()
	 ...
	 */
	@SuppressWarnings("unused")
	public static final ConfigOption<String> FLINK_YARN_CONF_DIR = key("env.yarn.conf.dir")
		.noDefaultValue()
	...
	public static final ConfigOption<Integer> DEFAULT_PARALLELISM = key("parallelism.default")
		.defaultValue(1)
	 ...
	 */
	@Documentation.Section(Documentation.Sections.COMMON_MISCELLANEOUS)
	public static final ConfigOption<String> DEFAULT_FILESYSTEM_SCHEME = key("fs.default-scheme")
			.noDefaultValue()
	...
	@Documentation.Section(Documentation.Sections.COMMON_MISCELLANEOUS)
	public static final ConfigOption<String> ALLOWED_FALLBACK_FILESYSTEMS = key("fs.allowed-fallback-filesystems")
			.stringType()
			.defaultValue("")
